---
name: "ppt-storyline-creator"
description: "AI-guided 8-step PPT creation workflow using storyline thinking. Clarify requirements, build narrative structure, generate rich Markdown drafts with Mermaid diagrams, plan slides, choose visual styles, run quality review, and hand off to Kimi/Gamma for final rendering. Supports both Chinese and English. Use when the user wants to create a presentation, PPT, slide deck, or pitch deck."
---
